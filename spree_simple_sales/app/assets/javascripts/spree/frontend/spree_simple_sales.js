...
$(document).ready(function () {
    ...
    //Toggle Children
    $(".menu-item-has-children").append("<span class='open-menu-link open'>+</span>");
    $('.menu-item-has-children').append("<span class='open-menu-link close'>-</span>");
    ...
    $('.nav-main > li').bind('mouseover', openSubMenu);
    $('.nav-main > li').bind('mouseout', closeSubMenu);
