...
class PaymentMethodsControllerTest < ActionController::TestCase
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post :create, payment_method: { last_4_digits: @payment_method.last_4_digits, stripe_customer_token: @payment_method.stripe_customer_token }
    end
  ...
  test "should update payment_method" do
    patch :update, id: @payment_method, payment_method: { last_4_digits: @payment_method.last_4_digits, stripe_customer_token: @payment_method.stripe_customer_token }
    assert_redirected_to payment_method_path(assigns(:payment_method))
  end
