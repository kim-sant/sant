...
(function() {
  ...
  jQuery(function() {
    ...
    return payment_method.setupForm();
  });

  payment_method = {
    setupForm: function() {
      return $('#new_payment_method').submit(function() {
    ...
    processCard: function() {
      ...
      return Stripe.createToken(card, payment_method.handleStripeResponse);
    },
    handleStripeResponse: function(status, response) {
      if (status === 200) {
        $('#payment_method_stripe_card_token').val(response.id);
        return $('#new_payment_method')[0].submit();
      } else {
